...
v0.0, January 14, 2015: Work in progress
...
[cols="1,2,4,4"]
|===
|v0.0 |14 JAN 2015 |Thomas Borg Salling <tbsalling@tbsalling.dk> |Work in progress.
|===
...
int main()
{
  char mystring[] = "AIVDM,1,1,0,,63@ndh@l=v9P=dD,2";
...
Thus -- this particular case -- the checksum is 0x61 and thus the complete NMEA amour containing our AIS data is:
