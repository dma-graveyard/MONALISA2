...
In order to support "good flow management" all _intended movements_ need to be managed. This process is called _flow management_. Flow management can take place between vessels on a peer-to-peer basis -- _autonomous flow management_ -- or between coordinating organizations and individual vessels -- _dependent flow management_.

In a fully managed scenario all vessels can safely and efficiently follow their intended movements through their entire passage of the area.

In order to facilitate flow management vessels in the area must transmit their intended movements. This allows other vessels in the area to adjust their own intended movements accordingly or for them -- or a shore-based coordination centre -- to suggest adjustments to the announced intended movements of other vessels.

A suggested change to an intended movement can be in two forms:
...
==== Use case 1: Dependent flow management

===== Initial state
The initial state is depicted here:
