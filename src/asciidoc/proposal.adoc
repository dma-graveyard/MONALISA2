...
=== Scope of work
The scope of the work in this paper is flow management - both controlled and autonomous; but limited to flow management suggestion s in the speed-based form.
...
- *tactical voyageplan inquiry*. An addressed message transmitted by coordination centers and vessels to inquire a vessel about its tactical voyageplans.
- *tactical voyageplan*. For a vessel to broadcast its tactical voyageplans.
...
[cols="2,6"]
.Payload of message type *tactical voyageplan inquiry*.
|===
...
[cols="2,6"]
.Payload of message type *tactical voyageplan*.
|===
| Data field | Description
...
[cols="2,6"]
.Payload of message type *flow management suggestion *.
|===
| Data field | Description
